...
<div class="row">
  <div id="carousel-port" class="carousel slide" data-ride="carousel" data-interval="3000">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
          ...
          <div class="col-lg-12"><img src="/portfolio/2020/mian_home.jpg" alt="image 1"></div>

      </div>
      <div class="item">

        <div class="col-lg-12"><img src="/portfolio/2020/mian_marble.png" alt="image 2"></div>
  ...
  <div class="legend">
    ...
    <ul>
      ...
      <li><a href="https://www.louismian.com" target="_blank">Live page</a></li>
