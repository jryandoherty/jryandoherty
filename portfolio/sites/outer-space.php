  ...
  <div class="row">
    <div class="legend">
      ...
      <ul>
        ...
        <li><a href="https://www.outerspacearts.xyz" target="_blank">Full site</a></li>
        <li><a href="https://github.com/jryandoherty/outer-space" target="_blank"><svg viewBox="0 0 32 32" class="github">
        ...
        <p>New site for the art gallery Outer Space.</p>
    </div>
  </div><!-- end row -->

  <div class="row">
      <object data="https://outerspacearts.xyz"></object>
  </div><!-- end row -->
