  ...
  <div class="row">
    ...
    <div class="legend">
      ...
      <ul>
        ...
        <li><a href="https://github.com/jryandoherty/leads_2016" target="_blank"><svg viewBox="0 0 32 32" class="github">
        ...
        <li>Partnership landing page for Buyerzone.com. This fully responsive page was built with the Bootstrap framework and features embeded SVGs and multiple animations triggered on scroll.</li>
      </ul>
    </div>
</div>
    <div class="col-lg-6">
