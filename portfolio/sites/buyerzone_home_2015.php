    ...
    <div id="carousel-port" class="carousel slide" data-ride="carousel" data-interval="3000">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="item">
          ...
          <div class="col-lg-12"><img src="/portfolio/2015/homepage/image-3.jpg" alt="image 3"></div>

        </div>

        <div class="item">

          <div class="col-lg-12"><img src="/portfolio/2015/homepage/image-4.jpg" alt="image 4"></div>
