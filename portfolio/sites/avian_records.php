    ...
    <div class="col-lg-6">
      <div class="legend">
        ...
        <ul>
          ...
          <li><strong>Theme:</strong> Teluro</li><li><a href="https://github.com/jryandoherty/maavianrecords" target="_blank"><svg viewBox="0 0 32 32" class="github">
          ...
          <li><a href="https://www.maavianrecords.com" target="_blank">Full Site</a></li>
        </ul>
...
<div class="row">
  <object name="frame" data="https://www.maavianrecords.com"></object>
</div><!-- end row -->
