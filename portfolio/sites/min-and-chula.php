...
<div class="webpage">
    ...
    <div class="col-lg-6">
      <div class="legend">
        ...
        <ul>
          ...
          <li><strong>Platform:</strong> Gatsby / React</li>
          <li><strong>Theme:</strong> Teluro</li>
          <li><a href="https://github.com/jryandoherty/gatsby-starter-default" target="_blank"><svg viewBox="0 0 32 32" class="github">
          ...
          <li><a href="https://www.minandchula.com" target="_blank">Full Site</a></li>
        </ul>
  ...
  <div class="col-lg-6">
    <picture>
       <source srcset="https://res.cloudinary.com/jryandoherty/image/upload/v1649434265/ma_avian_qises7.webp" type="image/webp" class="three-screens">
       <img src="https://res.cloudinary.com/jryandoherty/image/upload/v1649434265/ma_avian_vit7qn.jpg" alt="three screens" class="three-screens">
    </picture>
  </div>
  </div><!-- end row -->

<div class="row">
  <object name="frame" data="https://www.minandchula.com"></object>
</div><!-- end row -->
