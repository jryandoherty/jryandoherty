...
<div class="row">
  <div id="carousel-port" class="carousel slide" data-ride="carousel" data-interval="3000">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
          <div class="col-lg-12"><img src="/portfolio/2022/roger/image-1.jpg" alt="image 1"></div>
      </div>
      <div class="item">
        <div class="col-lg-12"><img src="/portfolio/2022/roger/image-2.jpg" alt="image 2"></div>
      </div>
  ...
  <div class="legend">
    ...
    <ul>
      ...
      <li><a href="https://www.rogerbuttles.com" target="_blank">Live page</a></li>
      <li><a href="https://github.com/jryandoherty/rogerbuttles" target="_blank"><svg viewBox="0 0 32 32" class="github">
