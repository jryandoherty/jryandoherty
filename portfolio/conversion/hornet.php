...
<div class="container webpage iframe">
  ...
  <div class="row">
    <object data="../2016/hornet/skidSteer.html"></object>
  </div>
  ...
  <div class="row">
    <div class="legend col-lg-6">
      ...
      <ul>
        ...
        <li><a href="https://github.com/jryandoherty/hornet" target="_blank"><svg viewBox="0 0 32 32" class="github">
      ...
      <p>Construction themed conversion page. This page was the final step in a marketing campaign starting with a promotional email sent to select potential customers in the construction business. The email would direct users either to a portal page, or directly to the conversion page.</p>
    </div>
