  ...
  <div class="row">
    ...
    <div class="legend">
      ...
      <ul>
        ...
        <li><a xlink:href="https://github.com/jryandoherty/trucks" target="_blank"><svg viewBox="0 0 32 32" class="github">
        ...
        <p>Trucking themed coversion page for Buyerzone.com.</p>
      </ul>
    </div>
  </div>
</div><!-- end container -->
